...
Write-Host " DeepSeek Harness Cockpit 一键编译构建脚本" -ForegroundColor Cyan
...
Write-Host (" 构建完成！输出目录: " + (Join-Path $ProjectRoot "dist")) -ForegroundColor Green
Write-Host "=========================================" -ForegroundColor Green

Get-ChildItem -Path (Join-Path $ProjectRoot "dist") -File -Filter "*.exe" -Recurse -ErrorAction SilentlyContinue | ForEach-Object {
